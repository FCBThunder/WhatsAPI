...
$nickname = "Cindy Vandenberghe";
$sender = 	"32483521298"; // Mobile number with country code (but without + or 00)
$imei = 	"98:D6:BB:BE:FF:08"; // MAC Address for iOS IMEI for other platform (Android/etc)
